        ...
        <div class="d-flex align-self-center justify-content-start">
            ...
            <div class="gutenblog-header-logo-wrap align-self-center width-200">
                ...
                if( display_header_text() ) { ?>
                    ...
                    <?php $gutenblog_text_logo = get_bloginfo('name'); ?>
                    <?php if($gutenblog_text_logo != ""){ ?>
                        <div class="header-logo-text gutenblog-header-logo-text">
                            <a class="header-logo-text-link" href="<?php echo esc_url(home_url('/')); ?>">
                                <?php echo esc_html($gutenblog_text_logo) ?>
                            </a>
                        </div>
                    <?php } ?>
                    ...
                    <?php if($tagline != ""){ ?>
                        <div class="tagline gutenblog-header-logo-tagline">
                            <?php if($tagline != '') { ?>
            ...
            <!-- Menu -->
            <div class="mr-auto align-self-center menu-width-header-4 menu-width-header <?php if($atleastonecontrol == 1){ echo esc_attr($menu_class); } ?>">
                <?php 
                $expanded = "";
            ...
            <!-- Controls -->
            <div class="d-flex align-self-center justify-content-start header-icons header-icon-color <?php if($atleastonecontrol == 1){ echo esc_attr($controls_wrap_class); } ?>">
                ...
                <?php
                if($gutenblog_header_settings_signin_btn == true){ ?>
                    <div class="user-wrap header-user-info-wrap bd-highlight align-self-center ">
                        <?php
