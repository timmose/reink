...
<!-- Header Row -->
<div class="header header-2 desktop-header-wrap">
    ...
    <div class="d-flex main-wrapper align-self-center justify-content-start">
        <!-- Logo -->
        <div class="p-2 align-self-center width-200">
            <?php
        ...
        <!-- Menu -->
        <div class="p-2 mr-auto align-self-center menu-width-header-4 menu-width-header <?php if($atleastonecontrol == 1){ echo esc_attr($menu_class); } ?>">
            <?php
            $expanded = "";
        ...
        <!-- Controls -->
        <div class="p-2 d-flex align-self-center justify-content-start header-icons header-icon-color <?php if($atleastonecontrol == 1){ echo esc_attr($controls_wrap_class); } ?>">
...
$gutenblog_header_wave_color_blend = gutenblog_get_option('gutenblog_header_wave_color_blend');
$gutenblog_header_wave_color_1 = gutenblog_get_option('gutenblog_header_wave_color_1');
$gutenblog_header_wave_color_2 = gutenblog_get_option('gutenblog_header_wave_color_2');
$gutenblog_header_wave_color_3 = gutenblog_get_option('gutenblog_header_wave_color_3');
$gutenblog_header_wave_color_back = gutenblog_get_option('gutenblog_header_wave_color_back');
$gutenblog_header_wave_color_back_mob = gutenblog_get_option('gutenblog_header_wave_color_back_mob');

$gutenblog_header_wave_color_back = hex_rgb($gutenblog_header_wave_color_back);
$gutenblog_header_wave_color_back_mob = hex_rgb($gutenblog_header_wave_color_back_mob);

?>
<div class="canvas-wrap">
    <canvas id="canvas-waves" data-blend="<?php echo esc_attr($gutenblog_header_wave_color_blend); ?>" data-color-background-mob="<?php echo esc_attr($gutenblog_header_wave_color_back_mob); ?>" data-color-background="<?php echo esc_attr($gutenblog_header_wave_color_back); ?>" data-color1="<?php echo esc_attr($gutenblog_header_wave_color_1); ?>" data-color2="<?php echo esc_attr($gutenblog_header_wave_color_2); ?>" data-color3="<?php echo esc_attr($gutenblog_header_wave_color_3); ?>" class="waves-canvas"></canvas>
</div>
<!-- /Wave -->
