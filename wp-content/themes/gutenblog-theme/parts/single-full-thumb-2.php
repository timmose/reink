            ...
            if($gutenblog_posts_featured_image_show == 1) {
                if(has_post_thumbnail()) { ?>
                    <div class="entry-thumb single-post-full-width-wrap">
                        ...
                        <div id="single-post-full-width-parallax-background" data-type="background" data-speed="3" style="background-image: url('<?php the_post_thumbnail_url($gutenblog_image_size); ?>')">
