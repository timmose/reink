...
<div class="single-post-bar">
    ...
    <div class="row two-columns single-page-main-row <?php if(has_post_thumbnail()){ echo "single-post-has-thumbnail"; } ?>">
        ...
        <?php  if($gutenblog_section_single_post_layout_select == 'Without-sidebar') { ?>
            ...
            if($gutenblog_posts_featured_image_show == 1) {
                if(has_post_thumbnail()) { ?>
                    <div class="entry-thumb single-post-full-width-wrap">
                        ...
                        <div id="single-post-full-width-parallax-background" data-type="background" data-speed="3" style="background-image: url('<?php the_post_thumbnail_url($gutenblog_image_size); ?>')"> </div>
            ...
            <div class="row main-wrapper single-post-full-width-parallax-margin <?php if(has_post_thumbnail()) { echo('single-has-thumbnail');} ?>">
