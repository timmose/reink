...
<?php endif; ?>
	...
	<?php
		...
		if ( ! is_single(  ) ) {
			...
			if ( is_home() && get_theme_mod( 'carrino_homepage_post_excerpt', true ) && ! get_theme_mod( 'carrino_homepage_post_thumbnail', true ) ||
		         ( is_archive() || is_search() ) && get_theme_mod( 'carrino_archive_post_excerpt', true ) && ! get_theme_mod( 'carrino_archive_post_thumbnail', true ) ) {
			...
			if ( 'post' === get_post_type() && has_excerpt( ) && get_theme_mod( 'carrino_single_custom_excerpt', true ) ) {
