...
Please install and activate it before starting to use the theme Yolox.
...
Theme documentation is available on http://yolox.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Yolox is Fontello.
