...
<div class="yolox_admin_notice yolox_rate_notice update-nag">
	...
	<div class="yolox_notice_text">
		...
		<p class="yolox_notice_text_info"><?php echo wp_kses_data( __( '* We love receiving 5-star ratings, because our CEO Henry Rise gives $5 to homeless dog shelter for every 5-star rating we get! Save the planet with us!', 'yolox' ) ); ?></p>
	</div>
	<?php
