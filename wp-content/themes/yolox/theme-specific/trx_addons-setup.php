...
if ( ! function_exists( 'yolox_trx_addons_meta_box_fields' ) ) {
	add_filter( 'trx_addons_filter_meta_box_fields', 'yolox_trx_addons_meta_box_fields', 10, 2 );
	function yolox_trx_addons_meta_box_fields( $mb, $post_type ) {
