					...
					'yolox_filter_comment_form_args', array(
						...
						'fields'               => array(
							'author' => yolox_single_comments_field(
								array(
									...
									'field_name'        => 'author',
									'field_title'       => esc_html__( 'Name', 'yolox' ),
									'field_placeholder' => esc_html__( 'Your Name', 'yolox' ),
								)
							),
							'email'  => yolox_single_comments_field(
								array(
									...
									'field_name'        => 'email',
									'field_title'       => esc_html__( 'E-mail', 'yolox' ),
									'field_placeholder' => esc_html__( 'Your E-mail', 'yolox' ),
								)
							),
						),
						...
						'comment_field'        => yolox_single_comments_field(
							array(
								...
								'field_value'       => '',
								'field_name'        => 'comment',
								'field_title'       => esc_html__( 'Comment', 'yolox' ),
								'field_placeholder' => esc_html__( 'Your comment', 'yolox' ),
							)
						),
					)
				);
