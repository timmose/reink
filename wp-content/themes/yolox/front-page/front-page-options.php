			...
			'options', 'blog', apply_filters(
				'yolox_filter_front_page_options', array(
					...
					'front_page_sections'     => array(
						...
						'desc'       => wp_kses_post( __( 'Drag and drop sections below to set up their order on the Front Page. You can also enable / disable any section.', 'yolox' ) ),
						'dependency' => array(
		...
		$options                                   = array_merge(
			$options, array(
				...
				'front_page_contacts_content'        => array(
					...
					'refresh' => false, 					'std'     => wp_kses_post( __( '<h5><span class="icon-home-2"> </span>Find us at the office:</h5><p>500, Lorem Street,<br />Chicago, IL, 55030<br />Mon - Fri, 09:00 - 18:00</p><h5> <span class="icon-mobile-light"> </span>Give us a call:</h5><p>Michael Jordan<br />+40 (123) 456-78-90<br />Mon - Fri, 08:00 - 22:00</p>', 'yolox' ) ),
					'type'    => 'text_editor',
				),
...
if ( ! function_exists( 'yolox_front_page_sidebars' ) ) {
		...
		$list['front_page_features_widgets']     = array(
			'name'               => esc_html__( 'Front Page section "Features"', 'yolox' ),
			'description'        => esc_html__( 'Widgets to be shown only in the section "Features" on the front page', 'yolox' ),
			'front_page_section' => true,
		);
		$list['front_page_team_widgets']         = array(
			'name'               => esc_html__( 'Front Page section "Team members"', 'yolox' ),
			'description'        => esc_html__( 'Widgets to be shown only in the section "Team members" on the front page', 'yolox' ),
			'front_page_section' => true,
		);
		$list['front_page_testimonials_widgets'] = array(
			'name'               => esc_html__( 'Front Page section "Testimonials"', 'yolox' ),
			'description'        => esc_html__( 'Widgets to be shown only in the section "Testimonials" on the front page', 'yolox' ),
			'front_page_section' => true,
		);
		$list['front_page_blog_widgets']         = array(
			'name'               => esc_html__( 'Front Page section "Latest Posts"', 'yolox' ),
			'description'        => esc_html__( 'Widgets to be shown only in the section "Latest Posts" on the front page', 'yolox' ),
			'front_page_section' => true,
		);
		if ( ! YOLOX_THEME_FREE ) {
			$list['front_page_googlemap_widgets'] = array(
				'name'               => esc_html__( 'Front Page section "Google map"', 'yolox' ),
				'description'        => esc_html__( 'Widgets to be shown only in the section "Google map" on the front page', 'yolox' ),
				'front_page_section' => true,
			);
		}
		return $list;
...
// Background image
if ( ! function_exists( 'yolox_customizer_partial_refresh_front_page_woocommerce_bg_image' ) ) {
	function yolox_customizer_partial_refresh_front_page_woocommerce_bg_image() {
		return yolox_customizer_partial_refresh_section( 'woocommerce' );
	}
}
