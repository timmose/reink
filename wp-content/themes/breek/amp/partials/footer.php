...
<footer id="footer" class="grid-container <?php echo esc_attr($footer_class); ?>">
    ...
    <?php if( is_active_sidebar('epcl_sidebar_footer_amp')  ): ?>
        <div class="widgets row gradient-effect">
            <div class="default-sidebar"><?php dynamic_sidebar( 'epcl_sidebar_footer_amp' ); ?></div>
            <div class="clear"></div>
        </div>
    <?php endif; ?>
    ...
    <?php if( empty($epcl_theme) || !isset($epcl_theme['enable_back_to_top']) || $epcl_theme['enable_back_to_top'] == '1' ): ?>
        <a id="back-to-top" class="epcl-button dark" on="tap:wrapper.scrollTo(duration=600)"><i class="remixicon remixicon-arrow-up-line"></i></a>
    <?php endif; ?>
