...
class AdmiralAdBlockAnalytics
{
     ...
     */
    public static function initialize($pluginCode, $pluginVersion)
    {
    ...
    public static function getPropertyIDInput()
    {
        ...
        <p class="description">The property ID is used to uniquely identify your site. If you already have an account at <a href="https://getadmiral.com">getadmiral.com</a> enter your property ID found on the property settings page here. If you don’t have an account yet don’t worry, just head to <a href="https://getadmiral.com/claim-property?d=' . get_site_url() . '&p=' . self::getPropertyID() .'">getadmiral.com/a/claim-property</a> to access your analytics.
        </td></tr></tbody></table>
